...
void display() {
    ...
    if (sequence == 0) {
        ...
        cout << "Используйте клавиши w (вверх), s (вниз), a (влево), d (вправо), чтобы перемещать плитки в определенном направлении." << endl;
        cout << "Удваивайте и объединяйте заголовки с одинаковым числовым значением" << endl << endl;
        for (int i = 0; i < 4; i++) {
            cout << "|-----------------------|" << endl;
            for (int j = 0; j < 4; j++) {
                cout << "|";
